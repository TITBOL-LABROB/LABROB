            ...
            for (var wk = 0; wk < weeksInMonth; wk++) {
                ...
                for (var dow = 0; dow < 7; dow++) {
                    if (dow < firstDow || currDayOfMonth > lastDayinMonth) {
                        ...
                        var d = new Date(year, month, currDayOfMonth);
                        var dia = currDayOfMonth;
                        var mes = month + 1;
                        var ano = year;
                        $dowElement.data('fecha', dia+'/' + mes + '/'+ ano);
                        $dowElement.data('nombreDia', d.getDay());
        ...
        function drawEvents($calendarElement, type) {
            ...
            if (events !== false) {
                $(events).each(function (index, value) {
                    ...
                    var Datos = value.date.split('/');
                    var dia = Datos[0];
                    var mes = Datos[1];
                    var ano = Datos[2];
                    if(dia.length==1)dia='0'+ dia;
                    if(mes.length==1)mes='0'+ mes;
                    var FechaIngles = ano+'-'+mes+'-'+dia;


                    //var id = $calendarElement.attr('id') + '_' + value.date;
                    var id = $calendarElement.attr('id') + '_' + FechaIngles;
                    var $dowElement = $('#' + id);
