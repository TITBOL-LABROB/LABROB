...
fullscreenButton.addEventListener('click', function(e) {
    ...
    if((window.innerWidth === screen.width && window.innerHeight === screen.height) || (window.fullScreen)) {
        exitFullscreen();
        fullscreenButton.innerHTML = "<i class='fa fa-toggle-off fa-fw'></i> Pantalla completa</a>";
    } else {
        enterFullscreen(document.documentElement);
        fullscreenButton.innerHTML = "<i class='fa fa-toggle-on fa-fw'></i> Salir pantalla completa</a>";
    }
});
