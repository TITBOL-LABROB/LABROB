...
<form action="?c=parametro&a=guardar" method="post" autocomplete="off">
    <input type="hidden" name="pkparametro" value="0" />
   <div class="row">
        <div class="col-md-6">
        ...
        <div class="form-group">
                ...
                <select class="form-control" name="pklaboratorio" >
                    <?php foreach ($laboratorios as $l): ?>
                        <option value="<?php echo $l->pklaboratorio; ?>" ><?php echo $l->nombre; ?></option>
                    <?php endforeach; ?>
                </select>
            </div>
        <div class="form-group">
