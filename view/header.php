...
<body>
	...
	<div class="navbar">
		<div class="navbar-inner">
			...
			<a href="index.php" style="float: left;"><img src="resources/img/lr.jpg" style="width:68px; height:48px;"></a>
				<a class="btn btn-navbar" data-toggle="collapse" data-target=".top-nav.nav-collapse,.sidebar-nav.nav-collapse">
					<span class="icon-bar"></span>
					<span class="icon-bar"></span>
					<span class="icon-bar"></span>
				</a>
				<a class="brand" href="index.html"><span>LABROB</span></a>
				...
				<div class="nav-no-collapse header-nav">
					<ul class="nav pull-right">
						...
						<li class="dropdown">
							<a class="btn dropdown-toggle" data-toggle="dropdown" href="#">
								<i class="halflings-icon white user"></i> LABROB
							...
							<ul class="dropdown-menu">
								...
								<li><a href="#"><i class="halflings-icon user"></i> Cambiar Contraseña</a></li>
