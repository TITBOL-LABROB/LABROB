...
$html="
 ...
 <body>
	...
	<table width='100%' style='border-collapse: collapse; border:0.7px solid #000000;' border='0'>
		<tr>
			<td colspan='2' style='font-size:10px;'><b>CONDICIONES DEL SERVICIO</b></td>
		</tr>
		<tr>
			<td style='font-size:9px;' width='35%'>TIEMPO DE ENTREGA:</td>
			<td style='font-size:9px;' width='65%'>18 Dias Habiles, sujeto a confirmacion en el momento de ingreso de la muestra</td>
		</tr>
		<tr>
			<td style='font-size:9px;'>FORMA ENTREGA INFORME RESULTADOS:</td>
			<td style='font-size:9px;'>En las instalaciones de LABROB presentando el Acta de Recepcion de Muestras</td>
		</tr>
		<tr>
			<td style='font-size:9px;'>FORMA PAGO:</td>
			<td style='font-size:9px;'>Se cancela segun convenio de trabajo</td>
		</tr>
		<tr>
