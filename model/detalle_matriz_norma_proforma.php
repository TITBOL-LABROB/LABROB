...
class detalle_matriz_norma_proforma{
    ...
    {
         try {
          return $this->pdo->insertInto('detalle_matriz_norma_proforma', $datos)->execute();
        } catch (Exception $e) {
            die($e->getMessage());
        }
    }
    ...
    public function Eliminar($pkdetalle_matriz)
    {
      try 
        {
           $this->pdo->deleteFrom('detalle_matriz_norma_proforma')
